...
const tick = () => {
  ...
  const ghostAngles = elapsedTime * 0.5;

  ghost1.position.x = Math.cos(ghostAngles) * 4;
  ghost1.position.z = Math.sin(ghostAngles) * 4;
  ghost1.position.y =
    Math.sin(ghostAngles) *
    Math.sin(ghostAngles * 2.34) *
    Math.sin(ghostAngles * 3.45);

  const ghost2Angles = -elapsedTime * 0.38;

  ghost2.position.x = Math.cos(ghost2Angles) * 5;
  ghost2.position.z = Math.sin(ghost2Angles) * 5;
  ghost2.position.y =
    Math.sin(ghost2Angles) *
    Math.sin(ghost2Angles * 2.34) *
    Math.sin(ghost2Angles * 3.45);

  const ghost3Angles = elapsedTime * 0.23;

  ghost3.position.x = Math.cos(ghost3Angles) * 6;
  ghost3.position.z = Math.sin(ghost3Angles) * 6;
  ghost3.position.y =
    Math.sin(ghost3Angles) *
    Math.sin(ghost3Angles * 2.34) *
    Math.sin(ghost3Angles * 3.45);
